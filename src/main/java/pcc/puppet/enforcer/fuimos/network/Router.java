...
public interface Router {
  ...
  Mono<AuthenticateDeviceEvent> authenticate(Device device);

  Mono<RelayMessageEvent> relay(Message message);

  Mono<AcknowledgeMessageEvent> acknowledge(Message message);

  Mono<SendMessageEvent> deliver(ChannelGateway gateway, Message message);
}
