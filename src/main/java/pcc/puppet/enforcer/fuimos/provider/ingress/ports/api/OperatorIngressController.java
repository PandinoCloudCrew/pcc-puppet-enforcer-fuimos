...
package pcc.puppet.enforcer.fuimos.provider.ingress.ports.api;
...
import pcc.puppet.enforcer.fuimos.provider.ingress.service.OperatorAuthenticationService;
...
public class OperatorIngressController {
  ...
  public ConsumerAuthenticationEvent authenticate(
      ...
      @Valid @RequestBody ConsumerAuthenticateCommand command)
